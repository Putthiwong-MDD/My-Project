...
require_once "db_login.php"; // ไฟล์เชื่อมต่อฐานข้อมูล
$error = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("SELECT id, password, role, employee_id, firstname, lastname, project, oms 
    ...
    if ($stmt->num_rows === 1) {
        $stmt->bind_result($userId, $hashed_password, $role, $emp_id, $firstname, $lastname, $project_code, $oms);
        $stmt->fetch();
